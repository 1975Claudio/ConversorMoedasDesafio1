...
public class PesoReal {
    public void menuPesoReal() {
        ...
        do {
            System.out.println("===============================================");
            System.out.println("Conversão de Peso para Real");
            System.out.println("1 - Inserir valor em Peso");
            System.out.println("0 - Sair");
            System.out.println("===============================================\n");
            System.out.print("Opção: ");

            while (!scanner.hasNextInt()) {
                System.out.println("Digite o valor inteiro em Peso que deseja converter: ");
                scanner.next();
            }
